...
import 'package:t_store/features/authentication/screens/signup.widgets/success_screen.dart';
...
class VerifyEmailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(onPressed: () => Get.offAll(() => LoginScreen()),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('darshan@gmail.com', style: Theme
                  .of(context)
                  .textTheme
                  .headlineMedium, textAlign: TextAlign.center,),
              const SizedBox(height: TSizes.spaceBtwItems,),
